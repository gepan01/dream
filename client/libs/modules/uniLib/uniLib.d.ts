...
declare module uniLib {
    class MsgBox extends eui.Panel {
        ...
        private _cacelCall;
        private _callObj;
        constructor(txt: string, title?: string, okTxt?: string, confirmCall?: Function, cacelTxt?: string, cacelCall?: Function, callObj?: any);
        private onTouch(e);
    }
}
...
declare module uniLib {
    class Scroller extends egret.Sprite {
        private content;
        ...
        private bg;
        private bgSh;
        constructor(content: egret.DisplayObject, mask: egret.Rectangle, isShowBg?: boolean, bgColor?: number, bgAlpha?: number);
        updateMask(mask: egret.Rectangle): void;
        private updateBg();
        private onContentResize(event);
        private onTouchBegin(event);
        private lastGapX;
        private lastGapY;
        private onTouchMove(event);
...
declare module uniLib {
    class CommonModelMgr {
        private static _self;
        constructor();
        static Instance: CommonModelMgr;
        private _models;
        private addEvents();
...
declare module uniLib {
    ...
    */
    class NetMgr {
         ...
         */
        static httpSend(msg: uniLib.IType, callback?: (response: uniLib.IType) => any, compress?: CompressType): void;
        /**
         * 发送长连接消息
         * @method uniLib.NetMgr.tcpSend
         * @param msg {any} 消息内容
         */
        static tcpSend(msg: uniLib.IType): void;
         ...
         * @param url
         */
        static CodeLogin(tel: string, code: string, password?: string, parent?: number, callBack?: any, loginfail?: (response: any) => boolean, thisObj?: any, url?: string): void;
        /**
         * email快速注册登录
         */
...
declare module uniLib {
    ...
    */
    class PayMgr {
        ...
        payByPmd(info: Pmd.CreatePlatOrderReturnSdkPmd_S, callBack?: any, thisObj?: any): void;
        /**
         * 打开或者跳转到平台支付
         * @param order {Cmd.RechargeChipsPlatOrderRet_S} 订单信息
         * @param callBack {Function} 支付成功回调函数
...
declare module uniLib {
    class PopUpMgr {
         ...
         */
        static addPopUp(panel: any, cotainer?: egret.DisplayObjectContainer, center?: boolean, modal?: boolean, index?: number, effectType?: PopUpEffect, popUpWidth?: number, popUpHeight?: number, panelParam?: any): any;
        /**
        * 移除面板方法
        * @param panel       	面板
...
declare module uniLib {
    ...
    */
    class ResLoadMgr extends egret.EventDispatcher {
         ...
         * 加载多个资源组
         */
        loadGrps(grpNames: string[], loadSucc?: Function, loadError?: Function, thisObj?: any, loadIngClass?: any, autoHideLoadUI?: boolean, isprocess?: boolean, mustResList?: any): void;
        /**
         * 加载资源组
         */
...
declare module uniLib {
    ...
    */
    class SceneMgr {
         ...
         * 改变当前场景
         */
        changeScene(sceneClass: any, params?: any, bMode?: boolean): any;
        /**
         * 获取当前场景
         */
        currentScene: IScene;
    ...
    */
    class UIMgr {
        ...
        */
         ...
         * @param cache 是否缓存
         */
        showUI(ui: any, data?: any, parent?: any, cache?: boolean, drag?: boolean): any;
        private startPoint;
        /**pan*/
         ...
         * 显示Loading
         */
        showProcessBar(loadClass?: any, loaded?: any, total?: number, desc?: string, resourceName?: string, force?: boolean): void;
        showLoadingTimeout(loadClass?: any, key?: string, timeout_msec?: number, desc?: string): void;
        private showLoading(loadClass?, loaded?, total?, desc?, resourceName?, force?, uiName?);
        /**
         * 显示例子效果
        ...
        hideLoading(loadClass?: any, uiName?: string, destroy?: boolean): void;
...
declare module uniLib {
    ...
    class JsonSocket {
        ...
        */
        ...
        sendTimeOut(message: IType, loopback?: boolean): void;
        send(message: IType, loopback?: boolean): void;
        sendPlat(message: IType, loopback?: boolean): void;
        sendEcho(): void;
...
declare module uniLib {
    class ConfigUtils {
        ...
        static appConfig: uniLib.AppConfig;
...
declare module uniLib {
    ...
    class Console {
        ...
        static infoEnable: boolean;
        static warn(message?: any, ...optionalParams: any[]): void;
        static warnEnable: boolean;
        static error(message?: any, ...optionalParams: any[]): void;
        static errorEnable: boolean;
    }
}
...
declare module uniLib {
    ...
    class DragonUtils {
         ...
         */
        static showFastDragon(frameName?: string, mcName?: string, armature?: string, x?: number, y?: number, container?: egret.DisplayObjectContainer, playTimes?: number, timeScale?: number, key?: string): dragonBones.Movie;
        /**
         * 通过容器移除龙骨动画
         * @container 	容器
         * @mcName 		动画名称
...
declare module uniLib {
    class GameModuleUtils {
        static checkJsIsExist(url: string): boolean;
        ...
        static LoadGame(url: string, docClassStr: string, params?: IGameConfig, loadingGameUI?: any, callBack?: Function, obj?: any): void;
        static loadGameTimeOut: number;
        static gameModleLoadedDic: any;
        /**
         * 游戏资源是否已经下载
         * @url 游戏代码路径
         */
        static gameDownloaded(url: string): boolean;
        static initGameLoadedDic(): void;
        /**
         * 下载游戏资源
         * @param 游戏参数
        ...
        static defaultDirect: boolean;
        static lastGame: number;
...
declare module uniLib {
    class Utils {
        ...
        static getCachedPlatInfo(onGetCached: Function, gameId: number, platid?: number, thisObj?: any): void;
        /**
         * 生成url二维码
    ...
    class ZQGameSdk {
       ...
       */
        ...
        */
        ...
        constructor();
        static init(call?: Function, thisObj?: any): void;
         ...
         * @param thisObj
         */
        static pickPhoto(call?: Function, thisObj?: any): void;
        /**
         * 更新Apk包
         * @param apkJson
         * @param onUpdate
